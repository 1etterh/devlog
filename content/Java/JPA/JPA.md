...
## 관련 문서
- [[JDBC|JDBC]] - JPA가 내부적으로 사용하는 데이터 접근 API
- [[MyBatis|MyBatis]] - SQL Mapper 방식의 대안 기술
- [[Spring Data JPA|Spring Data JPA]] - Spring에서의 JPA Repository 추상화
- [[Spring Framework|Spring Framework]] - JPA와 함께 사용하는 프레임워크
- [[TRANSACTION|DB 트랜잭션]] - JPA의 트랜잭션 관리 기반
