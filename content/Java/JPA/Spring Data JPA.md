...
## 관련 문서
- [[JPA|JPA]] - Spring Data JPA의 기반 기술
- [[Persistence Context|영속성 컨텍스트]] - Entity의 생명주기 관리
- [[JPA/Entity|Entity]] - Repository가 관리하는 영속성 객체
- [[Spring Framework|Spring Framework]] - Spring Data JPA가 속한 프레임워크
- [[Propagation & Isolation|트랜잭션 전파행위 & 격리수준]]
