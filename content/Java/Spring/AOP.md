...
## 관련 문서
- [[Spring Framework|Spring Framework]] - AOP가 포함된 프레임워크
- [[Propagation & Isolation|트랜잭션 전파행위 & 격리수준]] - AOP 기반으로 동작하는 @Transactional
- [[Bean|Bean]] - AOP Proxy가 적용되는 대상
- [[Dependency Injection|DI]] - AOP와 함께 Spring의 핵심 기능
