...
> Calendar의 생성자는 protected 이므로 getInstance()를 통해 객체를 생성할 수 있다. 일반적으로 Calendar을 상속받은 GregorianCalendar 객체가 반환된다.
...
> Calendar 객체도 Simple Date Format 을 활용하여 출력할 수 있다.
