...
## 관련 문서
- [[MyBatis|MyBatis]] - JDBC를 구조화한 영속성 프레임워크
- [[JPA|JPA]] - JDBC 위에서 동작하는 ORM 기술
- [[Prepared Statement|PreparedStatement]] - SQL Injection 방지를 위한 Statement
- [[TRANSACTION|DB 트랜잭션]] - JDBC의 commit/rollback 기반
- [[SQL|SQL]] - JDBC로 실행하는 쿼리 언어
