...
![[Java/Class/assets/IntelliJ_ClassDiagram.png]]
...
## 관련 문서
- [[OOP|OOP]] - 상속은 OOP 4대 특징 중 하나
- [[Polymorphism|다형성]] - 상속이 토대가 되는 OOP 특징
- [[Abstract Class|추상 클래스]] - 상속을 통해 구현하는 추상화 도구
- [[Interface|인터페이스]] - 다중 상속을 지원하는 추상화 도구
- [[Encapsulation|캡슐화]] - 상속과 함께 사용되는 OOP 특징