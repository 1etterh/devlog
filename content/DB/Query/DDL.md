...
## 관련 문서
- [[Design Process|DB 설계 프로세스]] - 물리 DB 설계에서 DDL로 구현
- [[DB/Modeling/Entity|Entity (Modeling)]] - DDL로 구현되는 설계 개체
- [[CONSTRAINTS|제약 조건]] - DDL에서 정의하는 데이터 무결성 규칙
- [[DML|DML]] - DDL로 생성된 테이블에 데이터를 조작하는 언어
- [[JPA/Entity|JPA Entity]] - DDL 대응 Java 매핑 객체