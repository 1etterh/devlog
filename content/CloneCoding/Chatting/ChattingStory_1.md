...
db.createUser({ user: "<USERNAME>", pwd: "<PASSWORD>", roles: [ { role: "readWrite", db: "chattingstorydb" } ] })
```
...
spring:
  data:
    mongodb:
      uri: mongodb://<USERNAME>:<PASSWORD>@localhost:27017/chattingstorydb?authSource=admin
```
