...
![[Spring/assets/IoCContainer_00.png]]
# references
...
## 관련 문서
- [[Servlet|Servlet]] - Spring MVC의 기반 기술
- [[AOP|AOP]] - 관점 지향 프로그래밍
- [[Propagation & Isolation|트랜잭션 전파행위 & 격리수준]]
- [[JPA|JPA]] - ORM 기반 데이터 접근
- [[MyBatis|MyBatis]] - SQL Mapper 기반 데이터 접근
- [[Spring Data JPA|Spring Data JPA]] - JPA Repository 추상화